/* ========= PERSONNALISATION ========= */
const NAME = "Hadil"; // mets "" si tu ne veux pas de prénom
...
/* Titre avec prénom (sécurité si tu changes le HTML) */
...
/* ========= OVERLAY "FAKE" ========= */
const HACK_TOTAL_DURATION = 5200; // <-- durée plus longue (ms)
...
noBtn.addEventListener("click", () => {
  ...
  // effet drôle : "Oui" grossit mais reste bloqué
  ...
  if (noCount >= MAX_NO){
    ...
    // Après l'overlay : Non disparaît + Oui devient enfin cliquable
    setTimeout(() => {
...
yesBtn.addEventListener("click", () => {
  // sécurité : si encore bloqué, ne rien faire
